...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📂Fɪʟᴇ :</b> <a href='https://telegram.me/{MAIN_CHANNEL_USRNM}'> {file_name} </a>\n\n<b>💾Sɪᴢᴇ : {file_size}</b>\n<b>⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽</b>\n<b><a href='https://telegram.me/{MOVIE_GROUP_USERNAME}'>Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ​</a>│<a href='https://telegram.me/{MOVIE_CHANNEL_USERNAME}'>Mᴏᴠɪᴇ Cʜᴀɴɴᴇʟ</a></b>\n<b>⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺</b>\n<b>Pʟᴇᴀꜱᴇ Fᴏʀᴡᴀʀᴅ Yᴏᴜʀ Fɪʟᴇs Tᴏ\nSᴀᴠᴇᴅ Mᴇꜱꜱᴀɢᴇ & Cʟɪᴄᴋ Oɴ Tʜᴇ\nCʟᴏꜱᴇ Bᴜᴛᴛᴏɴ.</b>")
